...
from worlds.spiritvalley.Data_Spirits import spirit_list, types, attacking_moves, all_moves, rand_grass_spawn, rand_water_spawn, rand_spirit_list, rand_type_chart, default_type_effective, default_grass_loc, default_water_loc
...
class SpiritValley(World):
    ...
    def generate_early(self):
        ...
        self.data["MAIN_QUEST_TOTAL_DOMINATION"] = random.choice(self.data["Grass_spawn"]["CaveOfTorment"])

        self.data["SIDE_QUEST_PERKY_PETUNIA_SPIRIT"] = random.choice(self.data["Grass_spawn"]["Trail1"])
        self.data["SIDE_QUEST_SLITHERING_MENACE_SPIRIT"] = random.choice(self.data["Grass_spawn"]["MillysFarm"])
        self.data["SIDE_QUEST_DEADLY_WATERS_SPIRIT"] = random.choice(self.data["Water_spawn"]["Trail11"])
        self.data["SIDE_QUEST_STARRY_EYED_SURPRISE_SPIRIT"] = random.choice(self.data["Grass_spawn"]["Trail12"])
        self.data["SIDE_QUEST_ARCTIC_MENACE_SPIRIT"] = random.choice(self.data["Grass_spawn"]["Trail15"])
        self.data["SIDE_QUEST_CENTIBOOB_1_SPIRIT"] = random.choice(self.data["Grass_spawn"]["Trail22"])
        self.data["SIDE_QUEST_CENTIBOOB_2_SPIRIT"] = random.choice(self.data["Grass_spawn"]["Trail22"])
        self.data["SIDE_QUEST_CENTIBOOB_3_SPIRIT"] = random.choice(self.data["Grass_spawn"]["Trail22"])
